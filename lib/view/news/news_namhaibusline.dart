...
class NewsNamhaibusline extends StatefulWidget {
  const NewsNamhaibusline({super.key});

  @override
  State<NewsNamhaibusline> createState() => _NewsState();
}

class _NewsState extends State<NewsNamhaibusline> {
